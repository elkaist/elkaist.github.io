!(function (i, s) {
  ...
  var e = "0.7.10",
    ...
    A = {
      rgx: function () {
        for (
          var i, e, o, r, w, l, d, p = 0, c = arguments;
          p < c.length && !l;
          ...
          if (typeof i === a) {
            ...
            for (r in m)
              m.hasOwnProperty(r) &&
                ((w = m[r]), typeof w === t ? (i[w[0]] = s) : (i[w] = s));
          }
          for (e = o = 0; e < u.length && !l; )
            if ((l = u[e++].exec(this.getUA())))
              for (r = 0; r < m.length; r++)
                (d = l[++o]),
                  (w = m[r]),
                  typeof w === t && w.length > 0
                    ? 2 == w.length
                      ? (i[w[0]] = typeof w[1] == n ? w[1].call(this, d) : w[1])
                      : 3 == w.length
                      ? (i[w[0]] =
                          typeof w[1] !== n || (w[1].exec && w[1].test)
                            ? d
                              ? d.replace(w[1], w[2])
                              : s
                            : d
                      ...
                      : 4 == w.length &&
                        (i[w[0]] = d
                          ? w[3].call(this, d.replace(w[1], w[2]))
                          : s)
                    : (i[w] = d ? d : s);
          p += 2;
        }
  ...
  (T.VERSION = e),
    (T.BROWSER = { NAME: p, MAJOR: l, VERSION: m }),
    (T.CPU = { ARCHITECTURE: f }),
    (T.DEVICE = {
      MODEL: d,
      VENDOR: u,
      TYPE: c,
    ...
    (T.ENGINE = { NAME: p, VERSION: m }),
    (T.OS = { NAME: p, VERSION: m }),
    typeof exports !== a
      ? (typeof module !== a &&
          module.exports &&
